...
| 09-16 | *this* | Scenario 6 `hand-typed-fix`: a typed number is Gate 1's to reject and costs no Gate 2 turn. M5 now 6 runs, 3/4 resolved. 457 tests (recorded as 456 in `02425bd`, corrected in the next commit). |
