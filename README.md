...
492 tests here: 98 for Gate 1, 126 for Gate 2 (checks, loop, and the tier
comparison), 40 for Gate 3 (checks and loop), and the rest covering the value registry, the log
