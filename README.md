...
558 tests here: 98 for Gate 1, 126 for Gate 2 (checks, loop, and the tier
comparison), 104 for Gate 3 (checks, model layer and loop), and the rest covering the value registry, the log
...
python -m rig.gate3_loop              # eight scenarios; a spent budget raises
